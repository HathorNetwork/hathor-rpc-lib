...
export function WalletProvider({ children }: WalletProviderProps) {
  ...
  // Register token - directly uses tokenState, no sync needed
  ...
  // Unregister token - directly uses tokenState, no sync needed
  ...
  const contextValue: WalletContextType = {
    ...
    // Token state - from the SINGLE SOURCE OF TRUTH (tokenState)
